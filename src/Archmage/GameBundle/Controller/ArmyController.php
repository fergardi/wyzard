...
class ArmyController extends Controller
{
    ...
    public function attackTarget($attacker, $attackerResearch, $attackerItem, $target)
    {
        ...
        if ($attackerPower < $defenderPower) {
            ...
            foreach ($player->getContracts() as $contract) {
                ...
                if ($skill->getBattle()) {
                    ...
                    if ($skill->getTerrainBonus() < 0) {
                        ...
                        $destroyed = $contract->getLevel() * $skill->getTerrainBonus() * $construction->getQuantity();
            ...
            //bajamos un nivel de un heroe enemigo al azar porque ha perdido
