...
class SkillFixtures extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $skill->setFamily($this->getReference('Dragones'));
        $skill->setType(null);
        $skill->setDescription('+'.$skill->getAttackBonus().'% <span class="label label-extra">Ataque</span>, +'.$skill->getDefenseBonus().'% <span class="label label-extra">Defensa</span> y +'.$skill->getSpeedBonus().' <span class="label label-extra">Velocidad</span> a tus <span class="label label-extra">'.$skill->getFamily()->getName().'</span>.');
        $skill->setFaction(null);
        $this->setReference($skill->getName(), $skill);
        $manager->persist($skill);
